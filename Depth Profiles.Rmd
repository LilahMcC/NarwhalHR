...
plot_dive <- function(dataframe, start_time, end_time, title, interactive = FALSE) {
  one_dive <- filter(dataframe, DateTime >= ymd_hms(start_time), DateTime <= ymd_hms(end_time))
...
```{r = plot_all_figures}
plot_dive(depth_data, '2018-08-23 22:46:00','2018-08-30 04:25:10',"Asgeir Dive Profile 2018 Deployment")
plot_dive(depth_data, '2018-08-24 00:00:00','2018-08-25 00:00:00', "Asgeir Dive Profile August 24, 2018")
plot_dive(depth_data, '2018-08-24 08:26:01', '2018-08-24 08:49:04', "Asgeir Dive Profile Single Dive August 24, 2018")
```

```{r plot_day, message = FALSE, echo = FALSE}
# start_day <- ymd_hms('2018-08-24 00:00:00')
# end_day <- start_day + days(1)
# one_day <- filter(depth_data, DateTime >= start_day, DateTime <= end_day) #sets time period
# day_plot<- ggplot(one_day, aes(x = DateTime, y = Depth)) + 
#   geom_line() +
#   scale_y_reverse() + #makes depth right orientation 
